                    ...
                    <div id="sidebar-scroll">
                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li>
                                    <a href="<?php echo base_url('daily_sales'); ?>" class="<?php if($this->uri->segment(1) == 'daily_sales') echo 'active'; ?>"><i class="fa fa-inr sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide"> Payment Billing</span></a>
                                </li>
