<div id="page-content">
    ...
    <div class="content-header">
        <ul class="nav-horizontal text-center">
            <li class="active">
                <a href="<?php echo base_url('dashboard'); ?>"><i class="fa fa-bar-chart"></i> Dashboard</a>
            </li>
            <li>
                <a href="<?php echo base_url('products'); ?>"><i class="gi gi-shopping_bag"></i> Products</a>
            </li>
            <li>
                <a href="<?php echo base_url('customers'); ?>"><i class="gi gi-user"></i> Customers</a>
            </li>
			<li>
                <a href="<?php echo base_url('payments'); ?>"><i class="fa fa-inr"></i> Payments</a>
            </li>
        </ul>
    </div>
