            ...
            <table id="example-datatable" class="table table-vcenter table-bordered table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-capitalize"><?php echo $staf['full_name']; ?></td>
						<td class="text-capitalize"><?php echo $staf['phone_number']; ?></td>
                        ...
                        <td class="text-center">
                            ...
                            <div class="btn-group">
                                ...
                                <a href="javascript:void(0)" data-id="<?php echo $staf['id']; ?>" onclick="deleteStaffData(this);" data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-times"></i></a>
                            </div>
                        </td>
                    </tr>
                    <?php
